 ...
 */
function economics_the_attached_image() {
	$post                = get_post();
	$attachment_size     = apply_filters( 'economics_attachment_size', array( 1200, 1200 ) );
 ...
 */
function economics_categorized_blog() {
	...
	if ( '1' != $all_the_cool_cats ) {
		// This blog has more than 1 category so economics_categorized_blog should return true
		return true;
	} else {
		// This blog has only 1 category so economics_categorized_blog should return false
		return false;
	}
}

/**
 * Flush out the transients used in economics_categorized_blog
 */
function economics_category_transient_flusher() {
	// Like, beat it. Dig?
	delete_transient( 'all_the_cool_cats' );
}
add_action( 'edit_category', 'economics_category_transient_flusher' );
add_action( 'save_post',     'economics_category_transient_flusher' );